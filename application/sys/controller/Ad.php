...
class Ad extends AdminBase
{
    ...
    public function positionlist()
    {
        ...
        */
        $btn = [
            [lang('adpst_list_row_btn_show'),'frame',lang('adpst_list_row_btn_show'),'fa fa-fw fa-eye','layui-btn-normal','Ad/adlist','position'],
        ...
        // 表格数据，分页，每页10条
        $Ad = Db::name('admin_ad_position') ->order(['sort'=>'ASC','id'=>'DESC']) ->paginate(tb_config('list_rows',1));  //取出当前语言版本下的所有配置项
        $ad_list = $Ad ->all();
